...
@pytest.mark.parametrize(
    ...
    [
        (dummy_hashmap([(1, "a"), (2, "b"), (3, "c")]), 3, (count_hash()(3), (3, "c"))),
        (dummy_hashmap([(1, "a"), (2, "b"), (3, "c")]), 4, (count_hash()(4), None)),
        (
        ...
        (
            ...
            (2, 3, 4),
            (count_hash()((2, 3, 4)), ((2, 3, 4), "b")),
        ),
        (
            dummy_hashmap([((1, 2, 3), "a"), ((2, 3, 4), "b")]),
            (2, 3, 4, 5),
            (count_hash()((2, 3, 4, 5)), None),
        ),
    ],
)
def test_get_entry_by_key(
    ...
    result = get_entry_by_key(hash_table, key)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (dummy_hashmap([(1, "a"), (3, "b")]), 2, "c", [(1, "a"), (2, "c"), (3, "b")]),
        (
...
def test_resize_hash_table() -> None:
    ...
    assert (
        ...
        and get_entry_by_key(table1, 11111111)[0]
        != get_entry_by_key(table2, 11111111)[0]
    )

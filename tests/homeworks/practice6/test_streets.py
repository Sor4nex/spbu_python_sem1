...
def test_mode_static() -> None:
    mode_static(
        "tests/homeworks/practice6/streets_logs.txt",
        "src/homeworks/practice6/my_streets_results.txt",
    )
    actual_results = open(
        "tests/homeworks/practice6/streets_results.txt", "r", encoding="utf-8"
    ).read()
    my_results = open(
        "src/homeworks/practice6/my_streets_results.txt", "r", encoding="utf-8"
    ).read()
